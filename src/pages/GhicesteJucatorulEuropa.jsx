...
const GhicesteJucatorulEuropa = () => {
  ...
  const mapPosition = (position) => {
    ...
    if (position.includes('right winger')) return 'W';
    if (position.includes('forward') || position.includes('striker')) return 'FW';
    return position;
  };
          ...
          <VStack w="100%" spacing={4}>
            {attempts.map((attempt, index) => (
              ...
              >
                ...
                >
                  <Image
                    src={getPlayerImagePath(attempt.player)}
                    fallbackSrc="https://cryptobully.s3.eu-north-1.amazonaws.com/fotbal-comedie/placeholder.png"
                    boxSize="40px"
                    borderRadius="full"
                    mr={3}
        ...
        <Modal isOpen={isGameOverOpen} onClose={onGameOverClose} isCentered closeOnOverlayClick={false}>
          ...
          <ModalContent bg="gray.800" color="white" mx={2}>
            ...
            <ModalBody pb={6} px={8}>
              <VStack spacing={4}>
                <Image
                  src={getPlayerImagePath(targetPlayer)}
                  fallbackSrc="https://cryptobully.s3.eu-north-1.amazonaws.com/fotbal-comedie/placeholder.png"
                  objectFit="fill"
                  mb={2}
                />
